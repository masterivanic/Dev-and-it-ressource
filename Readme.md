...
- [Go cookbook](https://go-cookbook.com/) - A comprehensive collection of practical Go code snippets, examples, and recipes for building efficient, reliable, and scalable applications.
...
- [Violit](https://github.com/violit-dev/violit) - The High-Performance Python Web Framework. The simplicity of Streamlit, minus the reruns
...
- [Google SRE](https://sre.google/sre-book/introduction/) - Google SRE article
