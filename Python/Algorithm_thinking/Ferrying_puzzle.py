"""
 ...
 . How can they all get across the river, leaving the two boys in the
 boat on the same side as they started?

 .Work out the minimum numbre of crossigs that boat must make

 our reason:
   adults = 20 , boys = 2 --> adults = 0 , boys = 2 ( 1 step )
   adults = 20 , boys = 1  <-- adults = 0 , boys = 1 ( 2 setp )
   adults = 19 , boys = 1 --> adults = 1 , boys = 1 (3 step) our first adult travel
   adults = 19 , boys = 2  <-- adults = 1 , boys = 0 

   adults = 19 , boys = 0  --> adults = 1 , boys = 2
   adults = 19 , boys = 1  <-- adults = 1, boys = 1
   adults = 18 , boys = 1 --> adults = 2 , boys = 1
   adults = 18 , boys = 2  <-- adults = 2 , boys = 0
   .... until all across
